...
namespace HY.Devices.Algorithm.Haier_TeBing
{
    ...
    public class RecognizeColor : AbstractAlgorithm, IAlgorithm
    {
        ...
        public override AlgorithmTypes AlgorithmType => AlgorithmTypes.ChromaticAberration;
        public override Dictionary<string, dynamic> InitParamNames { get; } = new Dictionary<string, dynamic>();

        public override Dictionary<string, dynamic> ActionParamNames { get; } = new Dictionary<string, dynamic> { { "Image", "" },{ "GmcPath","" },{ "NamesPath",""} };
        ...
        public override Dictionary<string, dynamic> DoAction(Dictionary<string, dynamic> actionParams)
        {
            try
            {
                ...
                results.Add("result", Find(hb_Image, actionParams["GmcPath"], actionParams["NamesPath"]));
                return results;
            }
            catch (Exception ex)
            {
