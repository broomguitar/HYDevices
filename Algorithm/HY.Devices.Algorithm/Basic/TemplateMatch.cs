...
namespace HY.Devices.Algorithm
{
    ...
    public class TemplateMatch
    {
        ...
        public bool TemplateMatch_ncm(string ImagePath, string ncmFilePath, double minScore, out double Score)
        {
            try
            {
                HOperatorSet.ReadImage(out HObject ho_Image, ImagePath);
                return TemplateMatch_ncm(ho_Image, ncmFilePath, minScore, 1, out Score);
        ...
        public bool TemplateMatch_ncm(Bitmap bitmap, string ncmFilePath, double minScore, out double Score)
        {
            try
            {
                HObject ho_Image = Utils.Ho_ImageHelper.Bitmap2HObject(bitmap);
