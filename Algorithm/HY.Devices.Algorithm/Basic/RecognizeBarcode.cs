...
namespace HY.Devices.Algorithm
{
    ...
    public class RecognizeBarcode
    {
        ...
        private static RecognizeBarcode _instance;
        public static RecognizeBarcode Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (_lockObj)
                    {
                        if (_instance == null)
                        {
                            _instance = new RecognizeBarcode();
                        }
                    }
                }
                return _instance;
        ...
        public string ReadBarCode(string hb_ImagePath)
        {
            try
            {
                HOperatorSet.ReadImage(out HObject hb_Image, hb_ImagePath);
                return ReadBarCode(hb_Image);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public string ReadBarCode(Bitmap bitmap)
        {
            try
            {
                return ReadBarCode(Utils.Ho_ImageHelper.Bitmap2HObject(bitmap));
            }
            catch (Exception ex)
            {
