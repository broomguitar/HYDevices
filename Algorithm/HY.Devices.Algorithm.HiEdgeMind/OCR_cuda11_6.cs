...
namespace HY.Devices.Algorithm.HiEdgeMind
{
    ...
    public class OCR_cuda11_6 : AbstractAlgorithm, IAlgorithm
    {
        #region OCR
        private const string dllPath = @".\Algorithms\ocr_cuda11.6\ppocr.dll";
        ...
        private static OCR_cuda11_6 _instance;
        public static OCR_cuda11_6 Instance
        {
            get
            {
                if (_instance == null)
        ...
        private object lockOcr = new object();
