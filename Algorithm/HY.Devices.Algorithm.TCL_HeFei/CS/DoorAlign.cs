...
namespace HY.Devices.Algorithm.TCL_HeFei
{
    ...
    public class DoorAlign : AbstractAlgorithm, IAlgorithm
    {
        ...
        public override Dictionary<string, dynamic> ActionParamNames { get; } = new Dictionary<string, dynamic> { { "Image", "" }, { "point1_LT_X", "" }, { "point1_LT_Y", "" }, { "point1_RB_X", "" }, { "point1_RB_Y", "" }, { "point2_LT_X", "" }, { "point2_LT_Y", "" }, { "point2_RB_X", "" }, { "point2_RB_Y", "" }, { "threholddata", 225 }, { "maxThreholddata", 255 } };
        ...
        private DoorAlignResult action_12_28(HObject hb_Image, int x0, int y0, int x1, int y1, int x00, int y00, int x10, int y10, int threholddata = 225, int maxThreholddata = 255)
        {
            ...
            { // Initialize local and output iconic variables 
                ...
                hv_Scale.Dispose();
                hv_Scale = 1;
                if ((int)(new HTuple(hv_Mean.TupleLess(0.1))) != 0)
                {
                    {
                        HTuple ExpTmpOutVar_0 = new HTuple();
                        ExpTmpOutVar_0.Append(1);
                        hv_Mean.Dispose();
                ...
                HOperatorSet.ScaleImage(ho_ImageReduced1, out ho_ImageScaled1, hv_Scale, 0);
                ho_Region.Dispose();
                ...
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    ...
                    HOperatorSet.ClosingRectangle1(ho_Region, out ho_RegionClosing, 5, (hv_Column12 - hv_Column1) / 10);
                }
                ...
                if ((int)(new HTuple(hv_Number.TupleGreater(0))) != 0)
                {
                    ...
                    hv_Indices.Dispose();
                    hv_Indices = new HTuple(new HTuple());
                    if (hv_Colxld.Length == 0)
                    {
                ...
                hv_Scale.Dispose();
                hv_Scale = 1;
                if ((int)(new HTuple(hv_Mean2.TupleLess(0.1))) != 0)
                {
                    {
                        HTuple ExpTmpOutVar_0 = new HTuple();
                        ExpTmpOutVar_0.Append(1);
                        hv_Mean2.Dispose();
                        hv_Mean2 = ExpTmpOutVar_0;
                        ExpTmpOutVar_0.Dispose();
                    }
                }
                ...
                HOperatorSet.ScaleImage(ho_ImageReduced2, out ho_ImageScaled2, hv_Scale2, 0);
                ho_Region2.Dispose();
