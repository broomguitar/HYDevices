...
namespace HY.Devices.Algorithm.TCL_HeFei
{
    ...
    public class LogoDetect : AbstractAlgorithm, IAlgorithm
    {
        private static readonly object _lockObj = new object();
        private static LogoDetect _instance;
        public static LogoDetect Instance
        {
            get
            {
                if (_instance == null)
        ...
        public override bool Init(Dictionary<string, dynamic> initParameters)
        {
            try
            {
                ...
                HOperatorSet.ReadDict(initParameters["class_HdictPath"].ToString(),
        ...
        private Dictionary<string, dynamic> Detect(HObject hb_Image)
        {
            ...
            try
            {
                ...
                results.Add("result", (string)((hv_DLResult.TupleGetDictTuple(
               "classification_class_names"))).TupleSelect(0));
                results.Add("score", (double)((hv_DLResult.TupleGetDictTuple(
               "classification_confidences"))).TupleSelect(0));
                return results;
            }
            catch (Exception ex)
            {
