...
namespace HY.Devices.Algorithm.AuxAirConditioningDetect
{
    ...
    public class SellotapeFold : AbstractAlgorithm, IAlgorithm
    {
        private static readonly object _lockObj = new object();
        private static SellotapeFold _instance;
        public static SellotapeFold Instance
        {
            get
            {
                if (_instance == null)
