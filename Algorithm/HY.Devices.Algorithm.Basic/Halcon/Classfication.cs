...
namespace HY.Devices.Algorithm.Basic.Halcon
{
    ...
    public class Classification : AbstractAlgorithm, IAlgorithm
    {
        ...
        public override Dictionary<string, dynamic> InitParamNames { get; }= new Dictionary<string, dynamic> { { "class_HdlPath", "" }, { "class_HdictPath", "" },{"useGpu",1 } };

        public override Dictionary<string, dynamic> ActionParamNames { get; }= new Dictionary<string, dynamic> { { "Image", "" }, { "Confidence", 80 } };
        // 分类模型
        ...
        public override bool Init(Dictionary<string, dynamic> initParameters)
        {
            ...
            try
            {
                ...
                HOperatorSet.ReadDlModel(initParameters["class_HdlPath"].ToString(), out hv_DLModelHandle);
        ...
        public override Dictionary<string, dynamic> DoAction(Dictionary<string, dynamic> actionParams)
        {
            try
            {
                ...
                results.Add("result", Detect(ho_Image, actionParams["Confidence"]));
                return results;
            }
            catch (Exception ex)
            {
        ...
        private string Detect(HObject hb_Image,double confidence)
        {
