...
namespace HY.Devices.Algorithm.Basic.Halcon
{
    ...
    public class DetectObject : AbstractAlgorithm, IAlgorithm
    {
        private static readonly object _lockObj = new object();
        private static DetectObject _instance;
        ...
        public override Dictionary<string, dynamic> InitParamNames { get; } = new Dictionary<string, dynamic> { { "detect_HdlPath", "E:\\Projects\\JiaoNan\\Fenlei_12091.hdl" }, { "detect_HdictPath", "E:\\Projects\\JiaoNan\\Fenlei_12091.hdict" } };
        ...
        public override bool Init(Dictionary<string, dynamic> InitParam)
        {
            try
            {
                ...
                HOperatorSet.ReadDict(InitParam["detect_HdictPath"],
                    new HTuple(), new HTuple(), out hv_DLDataset);
                hv_DLModelHandle.Dispose();
                HOperatorSet.ReadDlModel(InitParam["detect_HdlPath"],
        ...
        public override Dictionary<string, dynamic> DoAction(Dictionary<string, dynamic> actionParams)
        {
            ...
            HObject ho_Image, ho_Rectangle = null, ho_RegionZoom = null;
            HObject ho_ObjectSelected = null, ho_ImageAffineTrans = null;
            ...
            HTuple hv_Name = new HTuple(), hv_Row = new HTuple(), hv_Col = new HTuple();
            HTuple hv_Length1 = new HTuple(), hv_Length2 = new HTuple();
            HTuple hv_Phi = new HTuple(), hv_Width = new HTuple();
            HTuple hv_Height = new HTuple(), hv_scalex = new HTuple();
            HTuple hv_scaley = new HTuple(), hv_HomMat2DIdentity = new HTuple();
            ...
            try
            {
                ...
                hv_Name.Dispose();
                HOperatorSet.GetDictTuple(hv_DLResult, "bbox_class_name", out hv_Name);
                //hv_Row.Dispose();
                //HOperatorSet.GetDictTuple(hv_DLResult, "bbox_row", out hv_Row);
                //hv_Col.Dispose();
                //HOperatorSet.GetDictTuple(hv_DLResult, "bbox_col", out hv_Col);
                //hv_Length1.Dispose();
                ...
                if ((int)(new HTuple(hv_confidence.TupleGreater(0.0))) != 0)
                {
                    ...
                    HOperatorSet.GenRectangle2(out ho_Rectangle, hv_Row, hv_Col, hv_Phi, hv_Length1,
                        hv_Length2);
                    ...
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        ...
                        HOperatorSet.HomMat2dRotate(hv_HomMat2DIdentity, hv_Phi.TupleRad(), hv_Row * hv_scalex,
                            hv_Col * hv_scaley, out hv_HomMat2DRotate);
                    }
                    ho_ImageAffineTrans.Dispose();
                    HOperatorSet.AffineTransImage(ho_Image, out ho_ImageAffineTrans, hv_HomMat2DRotate,
                        "constant", "false");
                }
                results.Add("result", hv_Name.S);
                return results;
