...
namespace HY.Devices.Algorithm.Basic.Yolo
{
    ...
    public class YoloV4_cuda_10_2 : AbstractAlgorithm, IAlgorithm
    {
        #region Yolo_GPU 函数
        ...
        private static YoloV4_cuda_10_2 _instance;
        public static YoloV4_cuda_10_2 Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (_lockObj)
                    {
                        if (_instance == null)
                        {
                            _instance = new YoloV4_cuda_10_2();
                        }
                    }
                }
                return _instance;
