...
namespace HY.Devices.Algorithm.Basic.Yolo
{
    ...
    public class YoloV4_cpu : AbstractAlgorithm, IAlgorithm
    {
        #region Yolo_CPU 函数
        private const string dllPath = @".\yolov4_cpu\yolo_cpp_dll.dll";
        ...
        private static YoloV4_cpu _instance;
        public static YoloV4_cpu Instance
        {
            get
            {
                if (_instance == null)
