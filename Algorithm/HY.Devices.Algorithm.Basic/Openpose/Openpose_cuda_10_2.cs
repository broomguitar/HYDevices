...
namespace HY.Devices.Algorithm.Basic.Openpose
{
    ...
    public class Openpose_cuda_10_2 : AbstractAlgorithm, IAlgorithm
    {
        #region Openpose
        private const string dllPath = @".\openpose_cuda10.2\03_keypoints_from_image.dll";
        ...
        private static Openpose_cuda_10_2 _instance;
        public static Openpose_cuda_10_2 Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (_lockObj)
                    {
                        if (_instance == null)
                        {
                            _instance = new Openpose_cuda_10_2();
                        }
                    }
                }
                return _instance;
