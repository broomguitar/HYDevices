...
namespace HY.Devices.Algorithm.Haier_ZhongDe
{
    ...
    public class ZDSurfaceInspectionByDL : AbstractAlgorithm, IAlgorithm
    {

        private static readonly object _lockObj = new object();
        private static ZDSurfaceInspectionByDL _instance;
        public static ZDSurfaceInspectionByDL Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (_lockObj)
                    {
                        if (_instance == null)
                        {
                            _instance = new ZDSurfaceInspectionByDL();
                        }
                    }
                }
                return _instance;
        ...
        public override Dictionary<string, dynamic> InitParamNames { get; } = new Dictionary<string, dynamic> { { "class_HdlPath", "I:\\算法替换\\fenlei.hdl" }, { "class_HdictPath", "I:\\算法替换\\fenlei.hdict" } };

        public override Dictionary<string, dynamic> ActionParamNames { get; } = new Dictionary<string, dynamic> { { "Image", "" }, { "Direction", "Left" }, { "minGray", 6 }, { "Area", 200 }, { "HWindow", null }, { "hv_bimageshow", 1 }, { "hv_bregionshow", 1 } };

        public HTuple hv_ExpDefaultWinHandle;
        private HTuple hv_DLPreprocessParamFenlei, hv_DLModelHandleFenlei;
        public override bool Init(Dictionary<string, dynamic> InitParam)
        {
            try
            {
                FenleiInt(InitParam["class_HdlPath"].ToString(), InitParam["class_HdictPath"].ToString(),
        ...
        public void FenleiInt(HTuple hv_DllPath, HTuple hv_DictPath,
    out HTuple hv_DLPreprocessParam, out HTuple hv_DLModelHandle)
        ...
        public override Dictionary<string, dynamic> DoAction(Dictionary<string, dynamic> actionParams)
        {
            ...
            HObject ho_Image, ho_ImageGray, ho_ImagePyramid = null;
            HObject ho_ImageSelect = null, ho_CircleRegion = null, ho_Lines = null;
            HObject ho_UnionContours = null, ho_SelectedXLD = null, ho_ObjectSelected = null;
            HObject ho_ContCircle = null, ho_Region = null, ho_RegionDilation = null;
            HObject ho_RegionDifference = null, ho_ImageReduced = null;
            HObject ho_ImageScaled = null, ho_ConnectedRegions = null, ho_ConnectedRegions1 = null;
            HObject ho_Rectangle1 = null, ho_MultiChannelImage = null;

            // Local control variables 

            HTuple hv_Path = new HTuple(), hv_BaseName = new HTuple();
            HTuple hv_Extension = new HTuple(), hv_Directory = new HTuple();
            HTuple hv_domain = new HTuple(), hv_Savepath = new HTuple();
            HTuple hv_SavePartPath = new HTuple(), hv_Sigma1 = new HTuple();
            HTuple hv_Sigma2 = new HTuple(), hv_threholddata = new HTuple();
            HTuple hv_Area_huashang_zangwu = new HTuple(), hv_Mean = new HTuple();
            HTuple hv_Deviation = new HTuple(), hv_SelectObj = new HTuple();
            HTuple hv_Dict = new HTuple(), hv_Number = new HTuple();
            HTuple hv_Target = new HTuple(), hv_Sigma = new HTuple();
            HTuple hv_Low = new HTuple(), hv_High = new HTuple(), hv_I = new HTuple();
            ...
            HTuple hv_QuexianRow1OUT = new HTuple(), hv_QuexianColumn1OUT = new HTuple();
            HTuple hv_QuexianRow2OUT = new HTuple(), hv_QuexianColumn2OUT = new HTuple();
            ...
            try
            {
                ...
                //读取测试图片路径
                hv_Path.Dispose();
                hv_Path = actionParams["Image"]; // "E:/测试图片/CEABA200101TAP77P4ZK/BackCamera_DetectSurface_20230707032313.jpg";
                ...
                {
                    HTuple
                      ExpTmpLocalVar_BaseName = new HTuple(hv_BaseName);
                    hv_BaseName.Dispose();
                    hv_BaseName = ExpTmpLocalVar_BaseName;
                }
                //检测类型
                hv_domain.Dispose();
                hv_domain = (string)actionParams["Direction"].ToLower(); // "r"
                char domain = hv_domain.S[0];
                //保存标注图路径
                hv_Savepath.Dispose();
                hv_Savepath = MarkerImagePath;//"E:/0_wl/中德外观/中德标注图";
                hv_SavePartPath.Dispose();
                hv_SavePartPath = PartImagePath;//"E:/0_wl/中德外观/中德part";
                //*******************************
                hv_Sigma1.Dispose();
                hv_Sigma1 = 10.0;
                hv_Sigma2.Dispose();
                ...
                hv_threholddata = int.Parse(actionParams["minGray"]);
                hv_Area_huashang_zangwu.Dispose();
                hv_Area_huashang_zangwu = int.Parse(actionParams["Area"]);
                //***********返回数据***************
                ...
                HOperatorSet.Intensity(ho_ImageGray, ho_Image, out hv_Mean, out hv_Deviation);
                hv_SelectObj.Dispose();
                hv_SelectObj = 1;
                //组织返回数据  类型Dict
                hv_Dict.Dispose();
                ...
                //*********************************
                //************Front****************
                //if (new HTuple(hv_domain.TupleEqual("f")) != 0)
                if (domain== 'f')

                {
                    ...
                    HOperatorSet.GenGaussPyramid(ho_ImageGray, out ho_ImagePyramid, "constant",
                        0.5);
                    hv_Number.Dispose();
                    HOperatorSet.CountObj(ho_ImagePyramid, out hv_Number);
                    ho_ImageSelect.Dispose();
                    HOperatorSet.SelectObj(ho_ImagePyramid, out ho_ImageSelect, hv_SelectObj);
                    //******** 0713加入代码 筛选圆
                    ho_CircleRegion.Dispose();
                    HOperatorSet.GenEmptyRegion(out ho_CircleRegion);
                    if ((int)(new HTuple(hv_Mean.TupleGreater(85))) != 0)
                    {
                        hv_Target.Dispose();
                        hv_Target = "dark";
                    }
                    ...
                    calculate_lines_gauss_parameters(10, 100, out hv_Sigma, out hv_Low, out hv_High);
                    ho_Lines.Dispose();
                    HOperatorSet.LinesGauss(ho_ImageSelect, out ho_Lines, hv_Sigma, hv_Low, hv_High,
                        hv_Target, "true", "bar-shaped", "true");
                    ho_UnionContours.Dispose();
                    HOperatorSet.UnionAdjacentContoursXld(ho_Lines, out ho_UnionContours, 50,
                        8, "attr_keep");
                    ho_SelectedXLD.Dispose();
                    HOperatorSet.SelectShapeXld(ho_UnionContours, out ho_SelectedXLD, ((new HTuple("ra")).TupleConcat(
                        "rb")).TupleConcat("circularity"), "and", ((new HTuple(600)).TupleConcat(
                        200)).TupleConcat(0.15), ((new HTuple(99999)).TupleConcat(99999)).TupleConcat(
                        1));
                    hv_Number.Dispose();
                    HOperatorSet.CountObj(ho_SelectedXLD, out hv_Number);
                    HTuple end_val72 = hv_Number;
                    HTuple step_val72 = 1;
                    for (hv_I = 1; hv_I.Continue(end_val72, step_val72); hv_I = hv_I.TupleAdd(step_val72))
                    {
                        ho_ObjectSelected.Dispose();
                        HOperatorSet.SelectObj(ho_SelectedXLD, out ho_ObjectSelected, hv_I);
                        ...
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            ...
                            HOperatorSet.GenCircleContourXld(out ho_ContCircle, hv_Row, hv_Column,
                                hv_Radius, 0, (new HTuple(360)).TupleRad(), "positive", 1.0);
                        }
                        ho_Region.Dispose();
                        HOperatorSet.GenRegionContourXld(ho_ContCircle, out ho_Region, "filled");
                        {
                            HObject ExpTmpOutVar_0;
                            HOperatorSet.Union2(ho_Region, ho_CircleRegion, out ExpTmpOutVar_0);
                            ho_CircleRegion.Dispose();
                            ho_CircleRegion = ExpTmpOutVar_0;
                        }
                    }
                    ho_RegionDilation.Dispose();
                    HOperatorSet.DilationCircle(ho_CircleRegion, out ho_RegionDilation, 50);
                    ho_RegionDifference.Dispose();
                    HOperatorSet.Difference(ho_ImageSelect, ho_RegionDilation, out ho_RegionDifference
                        );
                    ho_ImageReduced.Dispose();
                    HOperatorSet.ReduceDomain(ho_ImageSelect, ho_RegionDifference, out ho_ImageReduced
                        );
                    //********************************************
                    ho_ImageScaled.Dispose();
                    ProsessImage(ho_ImageReduced, out ho_ImageScaled, 120);
                    ho_ConnectedRegions.Dispose(); ho_ConnectedRegions1.Dispose();
                    FftCheck(ho_ImageScaled, out ho_ConnectedRegions, out ho_ConnectedRegions1,
                    ...
                    defect_classification_function(ho_ImageScaled, ho_ConnectedRegions1, out ho_Rectangle1,
                    ...
                    save_biaozhu_image(ho_Image, out ho_MultiChannelImage, hv_Savepath, hv_BaseName,
                        hv_Dict, hv_SelectObj);
                    //************Left*********************
                }
                //else if (new HTuple(hv_domain.TupleEqual("l")) != 0)
                if (domain == 'l')

                {
                    ...
                    HOperatorSet.SelectObj(ho_ImagePyramid, out ho_ImageSelect, hv_SelectObj);
                    ho_ImageScaled.Dispose();
                    ProsessImage(ho_ImageSelect, out ho_ImageScaled, 120);
                ...
                // else if (new HTuple(hv_domain.TupleEqual("t")) != 0)
                if (domain == 't')

                {
                    ho_ImageScaled.Dispose();
                    ProsessImage(ho_ImageGray, out ho_ImageScaled, 120);
                    hv_Width.Dispose(); hv_Height.Dispose();
                    HOperatorSet.GetImageSize(ho_ImageScaled, out hv_Width, out hv_Height);
                    ho_ConnectedRegions.Dispose(); ho_ConnectedRegions1.Dispose();
                    FftCheck(ho_ImageScaled, out ho_ConnectedRegions, out ho_ConnectedRegions1,
                ...
                //else if ((int)new HTuple(hv_domain.TupleEqual("b")) != 0)
                if (domain == 'b')
                ...
                hv_QuexianRow1OUT.Dispose();
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_QuexianRow1OUT = hv_Dict.TupleGetDictTuple(
                        "QuexianRow1");
                }
                hv_QuexianColumn1OUT.Dispose();
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_QuexianColumn1OUT = hv_Dict.TupleGetDictTuple(
                        "QuexianColumn1");
                }
                hv_QuexianRow2OUT.Dispose();
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_QuexianRow2OUT = hv_Dict.TupleGetDictTuple(
                        "QuexianRow2");
                }
                hv_QuexianColumn2OUT.Dispose();
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_QuexianColumn2OUT = hv_Dict.TupleGetDictTuple(
                        "QuexianColumn2");
                }

                for (int i = 0; i < hv_QuexiannumOUT; i++)
                {
                    quexianResultInfos.Add(new TargetResult { Area = hv_QuexianAreaOUT[i].D, TypeName = hv_QuexianTypeOUT[i].S, Column1 = hv_QuexianColumn1OUT[i].I, Column2 = hv_QuexianColumn2OUT[i].I, Row1 = hv_QuexianRow1OUT[i].I, Row2 = hv_QuexianRow2OUT[i].I, Score = hv_ResultScoreOUT[i].D });
        ...
        private void calculate_lines_gauss_parameters(HTuple hv_MaxLineWidth, HTuple hv_Contrast,
      out HTuple hv_Sigma, out HTuple hv_Low, out HTuple hv_High)
        ...
        private void ProsessImage(HObject ho_Image, out HObject ho_ImageScaled, HTuple hv_StandardMean)
        {
            ...
            try
            {
                ...
                {
                    ho_ImageScaled.Dispose();
                    HOperatorSet.ScaleImage(ho_Image, out ho_ImageScaled, 1, 50);
                }
                else
                {
                    ho_ImageScaled.Dispose();
                    HOperatorSet.ScaleImage(ho_Image, out ho_ImageScaled, 1, 20);
                }
        ...
        private void save_biaozhu_image(HObject ho_Image, out HObject ho_MultiChannelImage,
            HTuple hv_Savepath, HTuple hv_filename, HTuple hv_Dict, HTuple hv_SelectObj)
        {
            ...
            {
                //create_dict (Dict)
                //set_dict_tuple (Dict, 'Quexiannum', 0)
                //set_dict_tuple (Dict, 'QuexianType', [])
                //set_dict_tuple (Dict, 'QuexianArea', [])
                //set_dict_tuple (Dict, 'ResultScore', [])
                //set_dict_tuple (Dict, 'QuexianRow1', [])
                //set_dict_tuple (Dict, 'QuexianColumn1', [])
                //set_dict_tuple (Dict, 'QuexianRow2', [])
                //set_dict_tuple (Dict, 'QuexianColumn2', [])
                ...
                if ((int)(hv_Dict.TupleGetDictTuple("Quexiannum")) != 0)
                {
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        ...
                        HOperatorSet.GenRectangle1(out ho_Rectangle1, (hv_Dict.TupleGetDictTuple(
                            "QuexianRow1")) * hv_SelectObj, (hv_Dict.TupleGetDictTuple("QuexianColumn1")) * hv_SelectObj,
                            (hv_Dict.TupleGetDictTuple("QuexianRow2")) * hv_SelectObj, (hv_Dict.TupleGetDictTuple(
                            "QuexianColumn2")) * hv_SelectObj);
                    }
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        ho_Rectangle2.Dispose();
                        HOperatorSet.GenRectangle1(out ho_Rectangle2, ((hv_Dict.TupleGetDictTuple(
                            "QuexianRow1")) - 10) * hv_SelectObj, ((hv_Dict.TupleGetDictTuple("QuexianColumn1")) - 10) * hv_SelectObj,
                            ((hv_Dict.TupleGetDictTuple("QuexianRow2")) + 10) * hv_SelectObj, ((hv_Dict.TupleGetDictTuple(
                            "QuexianColumn2")) + 10) * hv_SelectObj);
                    }
                    ho_RegionDifference.Dispose();
                ...
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_SavepathImage = ((hv_Savepath + "/") + "biaozhun-") + hv_filename;// + Guid.NewGuid().ToString();
                }
                hv_FileExists.Dispose();
                HOperatorSet.FileExists(hv_Savepath, out hv_FileExists);
                if ((int)(hv_FileExists) != 0)
                {
                    HOperatorSet.WriteImage(ho_MultiChannelImage, "jpeg 80", 0, hv_SavepathImage);
                }
                else
                {
                    try
                    ...
                    {
                        throw new Exception($"{hv_Savepath}" + ex.ToString());
                    }
                    HOperatorSet.WriteImage(ho_MultiChannelImage, "jpeg 80", 0, hv_SavepathImage);
                }
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
        ...
        private void save_part_picture(HObject ho_ImagePartdomain, HTuple hv_SavePartPath,
            HTuple hv_DLResult, HTuple hv_Index2)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        throw new Exception($"{hv_path}" + ex.ToString());
                    }
                    HOperatorSet.WriteImage(ho_ImagePartdomain, "jpeg 100", 0, hv_imagename);
                }
        ...
        private void defect_classification_function(HObject ho_ImageScaled, HObject ho_Image,
    ...
    HTuple hv_DLModelHandleFenlei, HTuple hv_Dict)
        {
            ...
            HObject ho_ImagePart, ho_ImageZoom;
            // end
            ...
            try
            {
                ...
                if ((int)(new HTuple(hv_Number1.TupleGreater(0))) != 0)
                {
                    ...
                    HTuple step_val15 = 1;
                    for (hv_Index2 = 1; hv_Index2.Continue(end_val15, step_val15); hv_Index2 = hv_Index2.TupleAdd(step_val15))
                    {
                        ...
                        //  有些背景是被裁掉的影响分类结果 zoom到400×400
                        ho_Region.Dispose();
                        HOperatorSet.Threshold(ho_ImagePartdomain, out ho_Region, 1, 255);
                        ho_ImageReduced.Dispose();
                        HOperatorSet.ReduceDomain(ho_ImagePartdomain, ho_Region, out ho_ImageReduced);
                        ho_ImagePart.Dispose();
                        HOperatorSet.CropDomain(ho_ImageReduced, out ho_ImagePart);
                        ho_ImageZoom.Dispose();
                        HOperatorSet.ZoomImageSize(ho_ImagePart, out ho_ImageZoom, 300, 300, "constant");

                        //  end
                        //将小图分类
                        hv_DLSample.Dispose();
                        gen_dl_samples_from_images(ho_ImageZoom, out hv_DLSample);
                        ...
                        //    save_part_picture(ho_ImageZoom, hv_SavePartPath, hv_DLResult, hv_Index2);
                        //}
                            ...
                            0))).TupleEqual("划痕"))) != 0)
                        {
                                ...
                                0))).TupleGreater(0.75))) != 0)
                            {
                                ...
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.SetDictTuple(hv_Dict, "Num0", (hv_Dict.TupleGetDictTuple(
                                        "Num0")) + 1);
                                }
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                            ...
                            0))).TupleEqual("擦伤"))) != 0)
                        {
                                ...
                                0))).TupleGreater(0.75))) != 0)
                            {
                                ...
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.SetDictTuple(hv_Dict, "Num2", (hv_Dict.TupleGetDictTuple(
                                        "Num2")) + 1);
                                }
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                            ...
                            0))).TupleEqual("脏污"))) != 0)
                        {
                                ...
                                0))).TupleGreater(0.75))) != 0)
                            {
                                ...
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.SetDictTuple(hv_Dict, "Num3", (hv_Dict.TupleGetDictTuple(
                                        "Num3")) + 1);
                                }
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
